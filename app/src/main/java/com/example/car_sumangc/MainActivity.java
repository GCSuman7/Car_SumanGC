package com.example.car_sumangc;
...
private Button btnCreateCar;
    ...
    private void initItems(){
        txtMake = findViewById(R.id.textMake);
        txtYear = findViewById(R.id.textYear);
        txtColor = findViewById(R.id.textColor);
        txtPurchasePrice = findViewById(R.id.textPurchasePrice);
        txtEngineSize = findViewById(R.id.textEngineSize);

        txtScrollable = findViewById(R.id.textScrollable);
